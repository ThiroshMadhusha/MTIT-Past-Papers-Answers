...
public class CommonConstant {
	...
	public static final String XML_DOCUMENT_STREET_VALUE = "Avenu Street";
	public static final String XML_DOCUMENT_NUMBER_VALUE = "115/1";
	public static final String XML_DOCUMENT_NAME_VALUE = "Nalaka Dissaayakee";
	public static final String XML_DOCUMENT_STREET_ADDRESS_VALUE = "No:115/1, Avenue Street, Randy";
	public static final String XML_DOCUMENT_INITIAL_VALUE = "S.A.";
	public static final String XML_DOCUMENT_STUDENT_XML_VALUE = "students.xml";
}
